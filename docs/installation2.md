...
Nirvor Communication এই পদ্ধতিটাই production-এ ব্যবহার করেছে। এটা official `nautobot-docker-compose` repository এবং Poetry ব্যবহার করে — plugin management এবং version upgrade অনেক সহজ হয়।

#### অটোমেটেড ডেপ্লয়মেন্ট স্ক্রিপ্ট

Nirvor Communication একটা automated deployment script তৈরি করেছে যা সব কিছু একসাথে করে দেয়:
...
Nautobot চালু হওয়ার পর Nirvor Communication দুটো গুরুত্বপূর্ণ plugin যোগ করেছে।
